doctorlists=[];
var temp;
async function fetchdocs(searchkey, searchkeySP){
    // for(i=1;i<8;i++){
    doctorlists=[];
    ...
    xmlhttp.onreadystatechange = function() {
        ...
        console.log(item.massage[0].username);     
           item.massage.forEach(element => {
            // console.log(element);
            dbtranslatetojson(element);
            docitem = temp;
            console.log(dbtranslatetojson(element));     
    ...
    xmlhttp.send();
    } else if (searchkeySP!="0"){
    xmlhttp.open("GET", "/web_darmankadeh/public/searchDoctorsBySpec?spec="+searchkeySP, false);
    xmlhttp.send();
    } else {
    xmlhttp.open("GET", "/web_darmankadeh/public/searchDoctors?name="+"", false);
    xmlhttp.send();
    }
    if (doctorlists.length==1){
    addres = "goToDoctorPage?id="+doctorlists[0].name;
    ...
    doctorlists.forEach(element => {
        ...
        <div>
            <div class="row w-100 mb-3 bg-white p-3 border-light-gray hover-melon rounded-10">
                <a
                        href="goToDoctorPage?id=${element.name}"
...
async function main(){
    ...
    searchkey = document.getElementById("shareDataName").innerHTML;
    searchkeySP = document.getElementById("shareDataٍSpec").innerHTML;


    if (searchkeySP == 'ارتوپدی') {
    searchkeySP = "1";
    } else if (searchkeySP == 'ادرار') {
    searchkeySP = "2";
    } else if (searchkeySP == 'پوست') {
    searchkeySP = "3";
    } else if (searchkeySP == 'زنان') {
    searchkeySP = "4";
    } else if (searchkeySP == 'اعصاب') {
    searchkeySP = "5";
    } else if (searchkeySP == 'دیگر') {
    searchkeySP = "6";
    }
    ...
    await fetchdocs(searchkey, searchkeySP);
